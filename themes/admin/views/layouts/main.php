...
<html>
    <head>
        ...
        <!-- Daterange picker -->
        <link rel="stylesheet" href=<?php echo Yii::app()->theme->baseUrl . "/plugins/daterangepicker/daterangepicker-bs3.css" ?>>
    ...
    <script src="<?php echo Yii::app()->theme->baseUrl; ?>/plugins/datatables/dataTables.bootstrap.min.js"></script>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs"> <?php echo Yii::app()->session['full_name'] ?> </span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src=<?php echo Yii::app()->theme->baseUrl . "/dist/img/user2-160x160.jpg" ?> class="img-circle" alt="User Imag e">
                                        <p>
                                            <?php echo Yii::app()->session['full_name'] ?> - Web Developer
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href=<?php echo Yii::app()->baseUrl . "/admin/logout" ?> class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                ...
                                <span>Destinations</span><i class="fa fa-angle-left pull-right"></i>

                            </a>
                            <ul class="treeview-menu">
                                <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Add Destination </a></li>
                                <li><a href=<?php echo Yii::app()->baseUrl . "/admin/destination" ?> ><i class="fa fa-circle-o"></i> List</a></li>
                 <!--               <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
                        ...
                        <li>
                            <a href="pages/widgets.html">
                                <i class="fa fa-th"></i> <span>Add itinerary</span> 
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2015-2016 <a href="">Suntravs Travel Management</a>.</strong> All rights reserved.
            </footer>
